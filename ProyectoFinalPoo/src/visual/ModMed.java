...
public class ModMed extends JDialog {
	...
	public ModMed(Medico aux) {
		...
		}
		{
			...
			txtEsp.setText(aux.getEspecialidad());
		}
		{
		...
		}
		{
			...
			txtDir.setText(aux.getDireccion());
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnMod.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						aux.setCedula(txtCedu.getText());
						aux.setTelefono(txtTel.getText());
						aux.setEspecialidad(txtEsp.getText());
						aux.setedad(Integer.valueOf(spnEdad.getValue().toString()));
						aux.setDireccion(txtDir.getText());
						dispose();
					}
				});
